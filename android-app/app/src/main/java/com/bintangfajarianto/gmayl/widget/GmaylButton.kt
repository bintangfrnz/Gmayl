...
fun GmaylPrimaryButton(
    ...
    Button(
        ...
        GmaylButtonContent(
            label = label,
            loading = loading,
            progressIndicatorColor = GmaylTheme.color.mist10,
        )
    }
}

@Composable
fun GmaylSecondaryButton(
    label: String,
    modifier: Modifier = Modifier,
    loading: Boolean = false,
    enabled: Boolean = true,
    ...
    Button(
        ...
        shape = CircleShape,
        enabled = enabled,
        border = BorderStroke(width = 1.dp, color = GmaylTheme.color.mist50),
        elevation = ButtonDefaults.buttonElevation(
            defaultElevation = 0.dp,
            pressedElevation = 0.dp,
        ),
        colors = ButtonDefaults.buttonColors(
            ...
            contentColor = GmaylTheme.color.mist70,
            disabledContainerColor = Color.Transparent,
            disabledContentColor = GmaylTheme.color.mist40,
        ),
    ) {
        GmaylButtonContent(
            label = label,
            loading = loading,
            progressIndicatorColor = GmaylTheme.color.mist70,
        )
    }
}
...
@Preview
@Composable
private fun GmaylSecondaryButtonPreview(
    @PreviewParameter(GmaylButtonParamProvider::class) param: GmaylButtonParamProvider.Param,
) {
